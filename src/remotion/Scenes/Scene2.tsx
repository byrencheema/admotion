...
const Scene2: React.FC = () => {
  ...
  const productName = "Grammarly";
  const features = ["Real-time Writing Assistant","Advanced Grammar Checking","Tone Detection","Vocabulary Enhancement"] || ['Premium Quality', 'Fast Performance', 'User Friendly'];
